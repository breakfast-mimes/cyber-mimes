export default {
  goNorth : ["Go North//DEV: why are we letting them go back to start? There's lit nothing there...",
  ...
  goSouth: ['South', 'Souther', 'Souther-er', 'Even More South' , 'Southest'],

  descriptionForward: ["Welcome to our game! It isn't much yet (we're still coding it as you play:D ) but we hope you enjoy it so far",
    "You like it so far? we worked real hard on this...",
    "Ok, you probably want to do something besides go south right? well just you wait, we got somethign EXCITING coming up",
  ...
  descriptionBackward: ["Wait why are you back here? if you would kindly go back south, that'd be much appreciated",
